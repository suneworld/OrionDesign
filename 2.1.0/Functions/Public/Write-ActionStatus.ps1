...
FUNCTION PURPOSE:
Completes action status lines with colored results and automatic right-alignment.
...
│ • Status Text       │    │ Auto to MaxWidth │    │ Line     │
...
or automatic pattern detection. The status text is automatically right-aligned
...
- 'Success' - Green/Cyan text (theme dependent)
- 'Failed' - Red text
- 'Warning' - Yellow text
...
Shows with right-aligned status:
...
Automatic alignment: Status text is automatically right-aligned to OrionMaxWidth.
